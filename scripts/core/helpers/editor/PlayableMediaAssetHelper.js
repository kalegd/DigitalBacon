...
export default class PlayableMediaAssetHelper extends AssetEntityHelper {
    ...
    static commonFields = {
        ...
        loop: { "parameter": "loop", "name": "Loop",
            "suppressMenuFocusEvent": true, "type": CheckboxInput },
        playTopic: { "parameter": "playTopic", "name": "Play Event", "type": TextInput },
        pauseTopic: { "parameter": "pauseTopic", "name": "Pause Event", "type": TextInput },
        stopTopic: { "parameter": "stopTopic", "name": "Stop Event", "type": TextInput },
