...
class ComponentPage extends DynamicFieldsPage {
    ...
    _createTitleBlock() {
        ...
        this._titleField = new TextField({
            ...
            'margin': 0,
            'onBlur': () => {
                this._component.editorHelper.updateName(
    ...
    setComponent(component) {
        ...
        this._setFields(component.editorHelper.getMenuFields());
    }
    ...
    _addSubscriptions() {
        ...
        PubSub.subscribe(this._id, PubSubTopics.COMPONENT_UPDATED, (message) =>{
            if(message.asset == this._component) {
